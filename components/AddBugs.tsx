                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    ...
                                    {project.name}
                                            ...
                                            <div className="flex items-center justify-between mt-1">
                                                ...
                                                <Link href={`/dashboard/projects/${project?.id}/bugs`}><span className="text-xs font-mono text-green-400 bg-green-950/50 border border-green-400/10 px-2 py-0.5 rounded-full md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                                                    Select →
                                                </span></Link>
                                            </div>
                                        </div>
