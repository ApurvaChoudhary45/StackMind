...
export default function PricingPage() {
  ...
  return (
    <section className="relative min-h-screen overflow-y-auto bg-black py-24 text-white">
      {/* Background Glow */}
      ...
      <div className="relative mx-auto max-w-4xl px-10">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-4 flex items-center justify-center gap-5">
            <span
              className={`font-medium ${!annual ? "text-white" : "text-zinc-500"
                }`}
            >
              Monthly
            </span>
            ...
            <button
              ...
              className={`relative h-8 w-16 rounded-full transition-all duration-300 ${annual ? "bg-emerald-500" : "bg-zinc-800"
                }`}
            >
              <span
                className={`absolute top-1 h-6 w-6 rounded-full bg-white transition-all duration-300 ${annual ? "left-9" : "left-1"
                  }`}
              />
            </button>
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-2">
          ...
          <div className="rounded-3xl dark:border dark:border-zinc-800 bg-white/5 p-8 backdrop-blur-xl transition duration-500 hover:border-zinc-700 hover:bg-white/10">
            ...
            <button className="mb-10 w-full rounded-xl border border-zinc-700 py-3 font-semibold transition hover:bg-zinc-900">
              Start Free
            </button>
