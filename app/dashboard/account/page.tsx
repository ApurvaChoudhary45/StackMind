        ...
        <div className="p-8 bg-background min-h-screen ">
            ...
            <div className="bg-card border border-border rounded-xl mb-3 overflow-hidden">
                <div className="px-5 py-4 border-b border-border">
                    ...
                    <p className="text-xs font-mono dark:text-zinc-500 light:text-black mt-0.5">Your public profile information</p>
                </div>
                <div className="p-5">
                    {/* Avatar + Info */}
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted">{fullName}</p>
                            <p className="text-xs font-mono text-text-muted">{user.email}</p>
                            <span className="inline-flex items-center gap-1 text-xs font-mono bg-card border border-green-400/10 px-2 py-0.5 rounded-full mt-1.5">
                    ...
                    <div className="mt-5 pt-4 border-t border-border">
                        {[
                            ...
                            <div key={field.label} className="flex justify-between items-center py-3 border-b border-border last:border-b-0 last:pb-0">
            ...
            <div className="bg-card border border-border rounded-xl mb-3 overflow-hidden">
                <div className="px-5 py-4 border-b border-border">
                    <p className="text-sm font-medium text-muted">Connected Accounts</p>
                    <p className="text-xs font-mono dark:text-zinc-500 light:text-black mt-0.5">Manage your third party connections</p>
                </div>
                <div className="p-5 flex flex-col gap-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm text-muted font-medium">Google</p>
                                {hasGoogle ? <p className="text-xs font-mono text-green-400">● connected</p> : <p className="text-xs font-mono text-text-muted">○ not connected</p>}
                            </div>
                        </div>
                        {hasGoogle ? (
                            canDisconnect ? (
                                ...
                                <div className="relative group">
                                    <button
                                        disabled
                                        className="text-xs font-mono text-zinc-700 border border-border px-3 py-1.5 rounded-lg cursor-not-allowed opacity-50"
                                    >
                                        Disconnect
                                    </button>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                {hasGithub ? <p className="text-xs font-mono text-green-400">● connected</p> : <p className="text-xs font-mono text-text-muted">○ not connected</p>}
                            </div>
                        </div>
                        {hasGithub ? (
                            canDisconnect ? (
            ...
            <div className="bg-card border border-red-400/10 rounded-xl overflow-hidden">
                ...
                <div className="p-5">
                    <p className="text-xs font-mono light:text-black mb-3">
